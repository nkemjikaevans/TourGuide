...
public class AttractionDetailActivity extends AppCompatActivity {
     ...
     * i.e,
     * {@link ArchitectureFragment} {@link NightLifeFragment}
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * 2    ->  Music and Nightlife : meaning intent received from {@link NightLifeFragment}
        ...
        switch (identifier) {
            case 1:
                ...
                break;
            case 2:
                setTitle(getString(R.string.nightlife_category));
                break;
            case 3:
